...
int main(int argc, char **argv)
{
    ...
    unisim_a_2000753867_0762929208_init();
    work_a_1948186814_2111220564_init();
    work_a_2991886867_3212880686_init();
    work_a_1316348740_3212880686_init();
    work_a_0338625579_2866195932_init();


    xsi_register_tops("work_a_0338625579_2866195932");

    IEEE_P_2592010699 = xsi_get_engine_memory("ieee_p_2592010699");
    xsi_register_ieee_std_logic_1164(IEEE_P_2592010699);
    STD_STANDARD = xsi_get_engine_memory("std_standard");
    WORK_P_0453171477 = xsi_get_engine_memory("work_p_0453171477");
